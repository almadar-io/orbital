...
(function (global, factory) {
  ...
  **/
  ...
  var index$3 = (function (list, keyAccessors) {
    ...
    function traverse(nodes) {
      ...
      for (var i = 0, l = nodes.length; i < l; i++) {
        ...
        if (currentDepth > node.depth) {
          ...
          traverse(node.out, [].concat(_toConsumableArray$2(nodeStack), [node]));
        }
      }
    }
  }
    ...
    methods: {
      ...
      tickFrame: function tickFrame(state) {
        ...
        function paintLinks() {
          ...
          var linksPerColor = index$3(defaultPaintLinks, [getColor, getWidth]);
          ctx.save();
        ...
        function paintArrows() {
          ...
          state.graphData.links.filter(getVisibility).forEach(function (link) {
            ...
            var bzLine = link.__controlPoints && _construct(bezierJs, [start.x, start.y].concat(_toConsumableArray$2(link.__controlPoints), [end.x, end.y]));
        ...
        function paintPhotons() {
          ...
          state.graphData.links.filter(getVisibility).forEach(function (link) {
            ...
            var bzLine = link.__controlPoints ? _construct(bezierJs, [start.x, start.y].concat(_toConsumableArray$2(link.__controlPoints), [end.x, end.y])) : null;
